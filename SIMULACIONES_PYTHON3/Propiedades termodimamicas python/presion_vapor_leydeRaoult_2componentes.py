...
class presion_vapor():
    ...
    def variables(self):
        ...
        self.A2=16.6769#float(input("ingrese la constante A de Antoine para la sustancia 1(mas volatil) :"))
        self.B2=3640.20#float(input("ingrese la constante B de Antoine para la sustancia 1(mas volatil) :"))
        self.C2=219.610#float(input("ingrese la constante C de Antoine para la sustancia 1(mas volatil) :"))
        self.A1=16.3872#float(input("ingrese la constante A de Antoine para la sustancia 2(menos volatil) :"))
        self.B1=3885.70#float(input("ingrese la constante B de Antoine para la sustancia 2(menos volatil) :"))
        self.C1=230.170#float(input("ingrese la constante  de Antoine para la sustancia 2(menos volatil) :"))
    ...
    def grafica_PvsY1(self):
        ...
        leg = pt.legend(loc='uper right', ncol=1, mode="center", shadow=True, fancybox=True)
...
#        pt.plot(self.X1,1-self.X1,'b',linewidth=2,label="fase vapor")
#        pt.grid(True)
#        pt.xlabel('Composicion X1,Y1')
