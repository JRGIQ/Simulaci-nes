# -*- coding: utf-8 -*-
"""
Created on Mon Jun 24 09:13:56 2019
...
class Simulador_etilbenceno():###orden sustancias=[etileno,etano,propileno,benceno,tolueno,etilbenceno,dietilbenceno]
    ...
    def parametros(self):
        ...
        print("***********************************************************************")
        print("[S O A V E---R E D L I C H---K W O N G]")
        print("***********************************************************************")
    ...
    def parametros_Ecuacion_Estado(self):
        ...
        self.fw=0.348+1.574*self.w-0.176*self.w**2  ### Funcion fw SRK Tabla 2.5 [Seader]
        ...
        self.a_pura=(0.42748*((self.R*self.Tc))**2/(self.Pc))*self.alpha ### Funcion a SRK Tabla 2.5 [Seader]
        self.b_pura=0.08664*((self.R*self.Tc)/(self.Pc))  ### Funcion a SRK Tabla 2.5 [Seader]
